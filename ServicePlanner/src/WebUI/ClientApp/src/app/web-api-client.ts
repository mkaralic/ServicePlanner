...
export interface IWorkOrdersClient {
    createWorkOrder(command: CreateWorkOrderCommand): Observable<number>;
    ...
    updateWorkOrder(id: number, command: UpdateWorkOrderCommand): Observable<FileResponse>;
    deleteWorkOrder(id: number): Observable<FileResponse>;
}
...
export class WorkOrdersClient implements IWorkOrdersClient {
    ...
    protected processCreateWorkOrder(response: HttpResponseBase): Observable<number> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<WorkOrder>;
                }
            } else
                return _observableThrow(response_) as any as Observable<WorkOrder>;
        }));
    }

    protected processGetWorkOrder(response: HttpResponseBase): Observable<WorkOrder> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = WorkOrder.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processUpdateWorkOrder(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    deleteWorkOrder(id: number): Observable<FileResponse> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteWorkOrder(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteWorkOrder(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<FileResponse>;
                }
            } else
    ...
    protected processDeleteWorkOrder(response: HttpResponseBase): Observable<FileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
